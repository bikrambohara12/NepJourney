...
//                 <img className='w-36 sm:w-40 cursor-pointer' src="/logo.png" alt="Logo" />
//                 <p className='border px-2.5 py-0.5 rounded-full border-gray-500 text-gray-600'>
//                     {aToken ? 'Admin' : 'Guide'} Mode
//                 </p>
//             </div>
//             <button onClick={logout} className='bg-blue-600 text-white text-sm px-10 py-2 rounded-full'>
//                 Logout
//             </button>
//         </div>
//     );
