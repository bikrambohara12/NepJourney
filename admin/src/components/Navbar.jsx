...
//         <img className='w-36 sm:w-40 cursor-pointer hover:scale-105 transition-all duration-300 hover:brightness-110 filter' src={assets.nep_logo} alt="Logo" />
...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center px-4 sm:px-10 py-3 border-b border-gray-700 bg-gray-900 shadow-lg shadow-gray-900/50'>
      <div className='flex items-center gap-2 text-xs'>
<img 
  className='h-30 w-40 scale-270 sm:h-14 cursor-pointer  transition-all duration-300 hover:brightness-110 filter object-contain' 
  src={assets.nep_logo} 
  alt="Logo" 
/>
      ...
      <button 
        onClick={logout} 
        className='bg-gradient-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 text-white text-sm px-10 py-2 rounded-full hover:scale-105 transition-all duration-300 hover:shadow-lg hover:shadow-red-500/30 font-medium'
      >
        Logout
      </button>
    </div>
