...
//       <h2 className="text-3xl font-semibold text-secondary-600 mb-8 inline-block border-b-4 border-yellow-400 pb-3 text-shadow-md/30 ">
//   Why Choose NepJourney?
// </h2>
//       <div className="flex flex-wrap justify-center gap-8 mt-8">
//         <div className="bg-white rounded-lg shadow-xl/20 p-8 w-[300px] hover:-translate-y-2 transform transition">
...
//           </h3>
//           <p className="text-gray-600 ">No matter the time zpne, we're here to help</p>
//         </div>
...
//     <section className="px-4 py-10 md:px-20 bg-gray-300  ">
//       <h2 className="text-2xl md:text-3xl font-semibold mb-8 text-center text-shadow-md/30 ">
...
//               <div className="absolute bottom-2 left-2 bg-black bg-opacity-60 text-white text-sm px-2 py-1 rounded shadow-xl/30">{tour.days}</div>
//             </div>
...
//   <button className="w-full sm:w-2/2 flex justify-center items-center gap-2 bg-yellow-400 hover:bg-yellow-500 text-black py-2 rounded-md transition">
//   Book Now</button>
...
import React from 'react';
import { FaMapMarkedAlt, FaUserTie, FaCalendarCheck, FaPhoneAlt } from 'react-icons/fa';
import { BsStars } from 'react-icons/bs'; // ✅ Added missing icon
    ...
    <>
      ...
      <section className="py-16 px-6 text-center bg-gray-300">
        ...
        <div className="flex flex-wrap justify-center gap-8 mt-8">
          <div className="bg-white rounded-lg shadow-xl/20 p-8 w-[300px] hover:-translate-y-2 transform transition">
            <FaMapMarkedAlt className="text-4xl text-yellow-500 mb-4 mx-auto" />
            <h3 className="text-xl font-semibold text-[#2c3e50] mb-2">Explore Destinations</h3>
            <p className="text-gray-600">
              Discover Nepal's most beautiful places with detailed information and cultural insights.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-xl/20 p-8 w-[300px] hover:-translate-y-2 transform transition">
            <FaUserTie className="text-4xl text-yellow-500 mb-4 mx-auto" />
            <h3 className="text-xl font-semibold text-[#2c3e50] mb-2">Local Guides</h3>
            <p className="text-gray-600">
              Connect with certified local guides who know the hidden gems and authentic experiences.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-xl/20 p-8 w-[300px] hover:-translate-y-2 transform transition">
            <FaCalendarCheck className="text-4xl text-yellow-500 mb-4 mx-auto" />
            <h3 className="text-xl font-semibold text-[#2c3e50] mb-2">Easy Booking</h3>
            <p className="text-gray-600">
              Simple and secure booking system for guides and travel services.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-xl/20 p-8 w-[300px] hover:-translate-y-2 transform transition">
            <FaPhoneAlt className="text-4xl text-yellow-500 mb-4 mx-auto" />
            <h3 className="text-xl font-semibold text-[#2c3e50] mb-2">24/7 Customer Support</h3>
            <p className="text-gray-600">No matter the time zone, we're here to help.</p>
          </div>
        </div>
      </section>
