...
const Guides = () => {
  ...
  const handleFilterClick = (tag) => {
    if (speciality === tag) {
      navigate('/guides'); // Reset to all guides if same tag clicked again
    } else {
      navigate(`/guides/${tag}`);
    }
  };
  ...
  return (
    <div className="px-6 md:px-12 py-10 pt-25">
      ...
      <div className="bg-cover bg-center text-white py-20 rounded-lg relative"style={{
        ...
        <div className="relative z-10 text-center">
          <h1 className="text-4xl md:text-5xl font-bold"> Discover the world with the <br /> best Traveller guide</h1>
