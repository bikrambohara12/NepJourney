      ...
      <form onSubmit={onSubmitHandler} className="mx-auto p-6 bg-white shadow-lg rounded-xl space-y-6 pb-2" >
        ...
        <div className="flex flex-col items-center">
          <label htmlFor="guide-image" className="cursor-pointer">
            ...
            <input onChange={onImageChange}  type="file" id="guide-image" hidden  />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input onChange={(e) => setEmail(e.target.value)} value={email} type="email" placeholder="Email"
              required  className="w-full border px-3 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
          ...
          <div>
            ...
            <input onChange={(e) => setFee(e.target.value)} value={fee} type="number" placeholder="Fee" required
              className="w-full border px-3 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
          ...
          <div>
            ...
            <input onChange={(e) => setEducation(e.target.value)} value={education} type="text" placeholder="Education" required
              className="w-full border px-3 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
          ...
          <div>
            ...
            <input onChange={(e) => setLocation(e.target.value)} value={location} type="text" placeholder="Location" required
              className="w-full border px-3 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"  />
          </div>

          <div>
            <label className="block text-gray-700 font-medium mb-1">Language</label>
            <input onChange={(e) => setLanguage(e.target.value)} value={language} type="text" placeholder="Language" required
              className="w-full border px-3 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
        </div>
        ...
        <div>
          ...
          <textarea onChange={(e) => setAbout(e.target.value)} value={about} placeholder="Write about guide" rows={5} required
            className="w-full border px-3 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" />
        </div>

        <div className="text-center">
          <button type="submit" disabled={loading}
            className={`bg-blue-600 text-white px-6 py-2 rounded-md transition $  loading ? 'opacity-50 cursor-not-allowed' : 'hover:bg-blue-700' }`} >
