...
// import React, { useContext, useState,setLoading,loading } from 'react';
// import { assets } from '../../assets/assets';
// import { AdminContext } from '../../context/AdminContext';
// import { toast } from 'react-toastify';
// import axios from 'axios';
...
//     //         formData.append('location', location)               // ✅ fixed here
//     //         formData.append('language', language)               // ✅ added this
...
//     } catch (error) {
//         setLoading(false); // ✅ Ensure it stops
//         toast.error(error.message);
//         console.log(error);
//     }
// }
...
//                     <div>
//                         <label className="block text-gray-700 font-medium mb-1">Location</label>
//                         <input onChange={(e) => setLocation(e.target.value)} value={location} type="text" placeholder="Location" required className="w-full border px-3 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" />
//                     </div>

//                     <div>
//                         <label className="block text-gray-700 font-medium mb-1">Language</label>
//                         <input onChange={(e) => setLanguage(e.target.value)} value={language} type="text" placeholder="Language" required className="w-full border px-3 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" />
//                     </div>
//                 </div>
